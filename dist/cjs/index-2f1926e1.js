...
BcText.props = {
  text: {
    defaultValue: "<p>Frost entered the room full of worry, Volkoff had been in a bad m<strong>ood all week and no one</strong> could figure out exactly what was wrong.</p>",
    type: 'long-text',
    optional: true
  }
};
...
BcText.preview = function () {
  return BcText.doRender({
    text: "<p>Frost entered the room full of worry, Volkoff had been in a bad m<strong>ood all week and no one</strong> could figure out exactly what was wrong.</p>"
  });
};
